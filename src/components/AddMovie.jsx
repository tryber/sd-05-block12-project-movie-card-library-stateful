  ...
  render() {
    ...
    return (
      <form>
        ...
        <input type="text" id="subtit" name="subtitle" value={subtitle} onChange={this.handleClick} />
        <label htmlFor="image">Imagem</label>
        <input type="text" id="image" name="imagepath" value={imagePath} onChange={this.handleClick} />
        <label htmlFor="sinopse">Sinopse</label>
        <textarea id="sinopse" name="sinop" value={storyline} onChange={this.handleClick} />
        <label htmlFor="avaliacao">Avaliação</label>
        <input type="number" id="avaliacao" name="aval" value={rating} onChange={this.handleClick} />
